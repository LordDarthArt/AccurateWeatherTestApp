...
class WeatherDatabaseHelper : SQLiteOpenHelper, BaseColumns {
    ...
    companion object {
        public val DATABASE_NAME = "tk.lorddarthart.accurateweathertestappweather.db"
        var DATABASE_VERSION = 1

        val DATABASE_WEATHER = "weather"
        val WEATHER_FILTERNAME = "weatherFilterName"
        val WEATHER_ID = "weather_id"
        val WEATHER_NOW = "weatherNow"
        val WEATHER_DATE = "weatherDate"
        val WEATHER_CITY = "weatherCity"
        val WEATHER_HIGH = "weatherHigh"
        val WEATHER_LOW = "weatherLow"
        val WEATHER_TEXT = "weatherText"
        val WEATHER_DESCRIPTION = "weatherDescription"
        val WEATHER_HUMIDITY = "mWeatherHumidity"
        val WEATHER_PRESSURE = "mWeatherPressure"
        val WEATHER_SUNRISE = "mWeatherSunrise"
        val WEATHER_SUNSET = "mWeatherSunset"
        val WEATHER_D1 = "mWeatherDay1"
        val WEATHER_D2 = "mWeatherDay2"
        val WEATHER_D3 = "mWeatherDay3"
        val WEATHER_D4 = "mWeatherDay4"
        val WEATHER_D5 = "mWeatherDay5"
        val WEATHER_D6 = "mWeatherDay6"
        val WEATHER_D7 = "mWeatherDay7"

        val DATABASE_WEATHER_CITY = "city"
        val WEATHER_CITY_ID = "city_id"
        val WEATHER_CITY_FILTERNAME = "city_name"
        val WEATHER_CITY_LATITUDE = "city_latitude"
        val WEATHER_CITY_LONGITUDE = "city_longitude"

        val DATABASE_CREATE_WEATHER_CITY_SCRIPT = ("create table "
        ...
        val DATABASE_CREATE_WEATHER_SCRIPT = ("create table "
                + DATABASE_WEATHER
